...
<body>
    ...
    <div class="container">
        <div class="title">retrait stock</div>
        <div class="content">
            <form method="post" action="">
                <div class="user-details">
                    <div class="input-box">
                       ...
                       <select name="" id="">
                            <?php
                                $stocksql = "SELECT designation FROM stock ";
                                $stockreq = mysqli_query($conn,$stocksql);
                                while($r=mysqli_fetch_assoc($stockreq)){
                                    echo "<option>" . $r['designation'] ."</option>";
                                }
                             ?>
                       </select>
                    </div>
